...
<head>
    ...
    <!-- TITLE -->
    <title>Laporan Tersedia - Perumahan Mentari Residence</title>
    <!-- ok -->
...
<body onload="window.print()">
    <table border="0" style="width: 100%">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <center>
                    <h2 class="auto-style1">Laporan Tersedia - Perumahan Mentari Residence</h2>
                </center>
            </td>
        </tr>
        </tbody>
    ...
    <table width="100%" class="tblcms2">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td class="text-center" colspan="3" align="center">Data Tersedia Kosong!!!</td>
                </tr>
            @endforelse
        </tbody>
    </table>
