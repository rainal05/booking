        ...
        <div class="col-lg-12">
            ...
            <div class=" shadow">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('blok', []) }}"> <i class="ti-arrow-left"
            ...
            {{-- Card --}}
            <div class="card">
                <form action="/blok/{{ $edit->id }}/update" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-row">
                        <div class="col-12 col-sm-12">
                            <label class="small mb-1" for="inputPassword">BLOK</label>
                            <input type="text" name="blok" value="{{ $edit->blok }}" class="form-control">
                        </div>
                    </div>
