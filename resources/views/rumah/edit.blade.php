        ...
        <div class="col-lg-12">
            ...
            <div class=" shadow">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('perumahan', []) }}"> <i class="ti-arrow-left"
            ...
            {{-- Card --}}
            <div class="card">
                <form action="/perumahan/{{ $edit->id }}/update" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-row mt-4">
                        ...
                        <div class="col-6 col-sm-6">
                            ...
                            <input type="number" name="no" value="{{ $edit->no }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-row mt-4">
